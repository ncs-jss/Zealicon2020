...
const useAudio = url => {
  ...
  return [playing, toggle, volume, changeVolume, forward, backward];
};

const Player = ({ url }) => {
  const [playing, toggle, volume, changeVolume, forward, backward] = useAudio(
    url
  );
      ...
      <div className="bottom-bar">
        <div className="container-fluid">
          <div className="row d-flex align-items-center">
            ...
            <div className="col-md-2 col-8 text-center px-0 d-flex align-items-center justify-content-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20.963"
                height="23.5"
